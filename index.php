          ...
          <div class="col-lg-4 col-md-8 col-12 mx-auto">
            <div class="card z-index-0 fadeIn3 fadeInBottom">
              <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                ...
                <br>
                  <img src="assets/img/logo.webp" alt="logo.png" srcset="" style="width: 70px; margin-left: 125px;">
                  <h4 class="text-white font-weight-bolder text-center mt-2 mb-0">Badan Pusat Statistik Kabupaten Aceh Singkil</h4> 
                  <!-- <div class="row mt-3">
